...
// Find the closing div of this block. The block has 3 divs being closed.
              ...
              <div className="lg:col-span-4 flex flex-col space-y-1">
                ...
                <div className="flex flex-wrap gap-1">
                  <button
                    ...
                    className={\`flex-1 min-w-[80px] py-1.5 px-2.5 text-xs font-bold rounded-xl flex items-center justify-center space-x-1.5 transition-all whitespace-nowrap cursor-pointer \${
                      activeTab === 'dashboard' 
                        ? theme.activeBtn
                  ...
                  <button
                    ...
                    className={\`flex-1 min-w-[90px] py-1.5 px-2.5 text-xs font-bold rounded-xl flex items-center justify-center space-x-1.5 transition-all whitespace-nowrap cursor-pointer \${
                      activeTab === 'queue' 
                        ? theme.activeBtn
                        : 'text-slate-600 hover:bg-white hover:text-slate-900 border border-transparent hover:border-slate-200/50 hover:shadow-xs'
                    }\`}
                ...
                <div className="flex flex-wrap gap-1">
                  ...
                  {['Admin', 'Dispatcher'].includes(currentUser?.role || '') && (
                    <button
                      ...
                      className={\`flex-1 min-w-[80px] py-1.5 px-2.5 text-xs font-bold rounded-xl flex items-center justify-center space-x-2 transition-all whitespace-nowrap cursor-pointer \${
...
console.log('Successfully updated App.tsx nav');
